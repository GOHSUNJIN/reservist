...
const AdminRoster = {
  ...
  build: function(self, s, accent, ctx) {
    ...
    return {
      ...
      markAllAbsentStyle:`flex:1;padding:6px 11px;border-radius:7px;cursor:pointer;border:1px solid #f7e4e1;background:#fff;color:#c0392b;opacity:${s.markingAllAbsent?'0.45':'1'};display:flex;align-items:center;justify-content:center;gap:5px;font-size:12px;font-weight:600;`,
      ...
      markAllPresentStyle:`flex:1;padding:6px 11px;border-radius:7px;cursor:pointer;border:1px solid #cfe6d8;background:#fff;color:#1f8a5b;opacity:${s.markAllPresenting?'0.45':'1'};display:flex;align-items:center;justify-content:center;gap:5px;font-size:12px;font-weight:600;`,
